    ...
    <div class="gridContainer">
        <div class="row middle-xs">
            <div class="col-sm-8 space-bottom-xs" data-type="column">
                <a class="button blue" href="/terms-of-service" target="_self" data-cp-link="1" rel="noopener">
                    Terms Of Service
                </a>
            </div>
            <div class="col-sm-4 end-sm" data-type="column">
                <a class="button blue" href="/privacy-policy" target="_self" data-cp-link="1" rel="noopener">
                    Privacy Policy
                </a>
            </div>
        </div>
